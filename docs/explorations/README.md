...
| 0002 | Key design (switch, mechanism, layout, look & feel) | decided — geometry superseded by [`octaves-plan.md`](../../hardware/3d/keyboard/octaves-plan.md) | [0002-key-design.md](0002-key-design.md) |
