...
[`src/09-audio-notes-gate`](../../src/09-audio-notes-gate/09-audio-notes-gate.ino).
...
[`src/09-audio-notes-gate`](../../src/09-audio-notes-gate/09-audio-notes-gate.ino) and the piano in
[`tools/keyboard-bridge.html`](../../tools/keyboard-bridge.html).
